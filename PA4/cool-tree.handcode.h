...
virtual Symbol get_name() = 0;							\
virtual void code(EnvP e, ostream& s) = 0;
...
void code(EnvP e, ostream& s);

#define attr_EXTRAS										\
bool is_method() { return false; }						\
Symbol get_type_decl() { return type_decl; }			\
Expression get_init_expr() { return init; }				\
void code(EnvP e, ostream& s) { return; }
...
#define Case_EXTRAS                             		\
virtual void dump_with_types(ostream& ,int) = 0;		\
virtual void code(ostream&, EnvP, int) = 0;				\
virtual Symbol get_type_decl() = 0;


#define branch_EXTRAS                                   \
void dump_with_types(ostream& ,int);					\
void code(ostream&, EnvP, int);							\
Symbol get_type_decl() { return type_decl; }
...
virtual void code(ostream&, EnvP) = 0; 					\
virtual void dump_with_types(ostream&,int) = 0;  		\
